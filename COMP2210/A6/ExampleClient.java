...
public class ExampleClient {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        WordLadderGame doublets = new Doublets(new FileInputStream(new File(new ExampleClient().getClass().getResource("sowpods.txt").getPath())));
        ...
        System.out.println(doublets.getMinLadder("tiger", "acrid"));
    }
}
